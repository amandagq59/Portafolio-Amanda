          ...
          <Card className="card-formacion-profesional text-center">
            <Card.Body>
              ...
              <Card.Text className="text-muted">
                Formación en intervención socioeducativa y promoción del
                bienestar e inclusión de personas y comunidades.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
        ...
        <div className="col-md-6 col-lg-4">
          <Card className="card-formacion-profesional text-center">
            <Card.Body>
              ...
              <Card.Text className="text-muted">
                Formación intensiva con foco práctico en desarrollo full stack
                moderno.
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <div className="col-md-6 col-lg-4">
          <Card className="card-formacion-profesional text-center">
            <Card.Body>
              ...
              <Card.Title>
                Coaching e Inteligencia Emocional Infantil y Adolescente
              </Card.Title>
              <Card.Subtitle className="mb-1 text-muted">
              ...
              <Card.Text className="text-muted">
                Formación en acompañamiento y desarrollo de habilidades
          ...
          <div className="col-md-6 col-lg-4">
            <Card className="card-formacion-profesional text-center">
              <Card.Body>
                ...
                <Card.Title>
                  Certificado Internacional en Prevención de la Violencia de
                ...
                <Card.Text className="text-muted">
                  Capacitación en prevención, sensibilización y educación
                  emocional aplicada a la igualdad y la protección frente a la
                  violencia de género.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <div className="col-md-6 col-lg-4">
            <Card className="card-formacion-profesional text-center">
              <Card.Body>
                ...
                <Card.Subtitle className="mb-1 text-muted">
                  Instituto Ben Gabirol
                </Card.Subtitle>
                <Card.Subtitle className="mb-2 text-muted">
                  2014-2016
                </Card.Subtitle>
                <Card.Text className="text-muted">
                  Formación en diseño y gestión de actividades educativas,
                  culturales y recreativas que fomentan la participación, la
